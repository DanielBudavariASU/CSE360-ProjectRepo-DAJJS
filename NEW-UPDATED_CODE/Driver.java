    ...
    class CardPane extends StackPane {
        ...
        private VBox createLoginPanel() {
            ...
            loginButton.setOnAction(e -> {
                ...
                if (foundUser != null && foundUser.validateLogin(passwordField.getText())) {
                	 ...
                	 else if(foundUser.getRole().getRoles().contains("User")) 
                	 {
                		 getChildren().add(createUserHomePage()); // Navigate to User home page
                	 }
                	 else
                	 {
                		 getChildren().add(createInstructorHomePage());
                	 }
         ...
         */
         ...
         private VBox createMultipleRolePage()
         {
             ...
             Button userButton = new Button("User"); // Option for User role
             ...
             instructorButton.setOnAction(e -> {
            	 getChildren().clear(); 
            	 getChildren().add(createInstructorHomePage()); // Navigate to admin home page
             });
