...
public class JUnit_Database {
    ...
    public void testHasAccessToArticle() {
        ...
        article.addSpecialAccessGroup("SpecialGroup"); //ensure article is linked to special access group
        ...
        // Test no access for unauthorized user
